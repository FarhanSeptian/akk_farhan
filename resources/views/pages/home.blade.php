            ...
            <div class="col-10 col-md-3 mx-1 my-3 p-1 rounded shadow-lg">
                <div class="d-flex justify-content-between alignitems-center">
                    <a href="{{ route('profile.people', $photo->user->id) }}"
                        ...
                        <span class="ms-2 fs-5 text-dark">{{ $photo->user->nama }}</span> </a>
                ...
                <a href="{{ route('photo.index', $photo->id) }}" class="text-decoration-none">
                    <img class="img mx-auto d-block" width="300"
                        src="{{ asset('storage/' . $photo->lokasi_file) }}"alt="{{ asset('storage/' . $photo->lokasi_file) }}">
                    <div id="post-detail" class="my-2 ms-3">
                        <span class="fw-bold fs-5 d-block textdark">{{ $photo->judul_foto }}</span>
